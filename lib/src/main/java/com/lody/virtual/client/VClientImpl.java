...
public final class VClientImpl extends IVClient.Stub {
    ...
    private void bindApplicationNoCheck(String packageName, String processName, ConditionVariable lock) {
        ...
        //VirtualHook Code. Not in original of VirtualApp.
        ...
        try {
            Log.d("myVH", "trying applyHookPlugin");
            Log.d("myVH", VPackageManager.get().getInstalledHookPlugins().length+"");
            ...
            String pluginName = "/sdcard/io.virtualhook/patch.apk";
            applyHookPlugin(
                    VEnvironment.getPackageResourcePath(pluginName).getAbsolutePath(),
                    VEnvironment.getPackageLibPath(pluginName).getAbsolutePath(),
                    targetClassLoader
            );
